...
import socket,threading,sys,os,platform

class socketclient:

    def __init__(self):
        self.client = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
        self.client.connect(('127.0.0.1', 8782))
    ...
    def send(self):
        while True:
            ...
            if msg != None and msg != b'':
                if msg != 'close':
                    try:
                        msg = len(msg).to_bytes(20,'big')+msg.encode('utf-8')
    ...
    def heartbeat(self):
        while True:
            ...
            time.sleep(10)
            try:
                msg = b'{"heard":"heartbeat","msg":{"check":"On-line"}}'
                ...
                msg = len(msg).to_bytes(20,'big')+msg
                self.client.sendall(msg)
